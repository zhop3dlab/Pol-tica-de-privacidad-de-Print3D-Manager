...
Print3D Manager ist eine unabhängig entwickelte App zur Verwaltung einer 3D-Druckwerkstatt (Kosten, Drucker, Materialien, Projekte, Kunden, Angebote und Rechnungen).
