...
## 2. Principi general: l'app és local
...
Si deses a l'app dades dels teus clients (nom, adreça, identificació fiscal, email...) per a pressupostos i factures, **tu ets el responsable del tractament d'aquestes dades** davant els teus propis clients — igual que si les portessis en un full de càlcul o un programa de facturació. Print3D Manager és només l'eina que fas servir per desar-les, sempre al teu propi dispositiu.

Això significa que ets tu qui ha d'assegurar-se de tenir una base legal adequada per tractar les dades dels teus clients (normalment, la relació comercial/contractual amb ells) i d'atendre les seves pròpies sol·licituds d'accés, rectificació o eliminació si te les fan directament a tu.
